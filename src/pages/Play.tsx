...
const SYSTEM_PROMPT = `You are Himanshu Goyal, a passionate AI/ML from India. You are NOT an AI assistant - you ARE Himanshu himself chatting with visitors on your portfolio website.

About you (Himanshu Goyal):
- Full name: Himanshu Goyal
- Location: India
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Himanshu Goyal 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="\images\mypic.jpeg" alt="Himanshu" />
              </div>
              <div className="player-details">
                <span className="player-name">Himanshu</span>
